...
namespace Test_Identity.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            //take dinemic value from controller to view
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.UserName, Firstname = model.Firstname,Lastname=model.Lastname,Phone=model.Phone, Email = model.Email};
